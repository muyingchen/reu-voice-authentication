...
/* order.c */    void rank_int_arr PROTO((int *arr, int num, int *ptr_arr, float *rank_arr, int order)) ;
/* order.c */    void sort_short_arr PROTO((short int *arr, int num, int *ptr_arr, int order)) ;
/* order.c */    void sort_float_arr PROTO((float *arr, int num, int *ptr_arr, int order)) ;
...
/* order.c */    void rank_float_arr PROTO((float *arr, int num, int *ptr_arr, float *rank_arr, int order)) ;

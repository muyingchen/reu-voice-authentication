...
echo "This package can be installed on the following platforms."
...
4:Dec OSF/1:gcc -ansi::cp:ranlib:ar ru:OSF1
5:SGI IRIX:cc -ansi::cp:ar -rs:ar ru:SGI
6:HP Unix:gcc -ansi::cp:ar -rs:ar -ru:HP
7:IBM AIX:cc:-g:cp:ranlib:ar ru:AIX
8:Custom:cc:-g:install -s -m 755:ranlib:ar ru:SUN' | tr '\012' ','`
Custom=8

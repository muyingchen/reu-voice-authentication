...
/* histogram.                                              */
void init_hist(HIST ***hist, int num_bins, float from, float to)
{
    HIST **th;
    int i;
    double dist;
...
float percentile_hist(HIST **hist, int num_bins, float percentile)
{
...
float percentage_left_hist(HIST **hist, int num_bins, float value)
{
...
float do_least_squares(HIST **noise, HIST **normal, int num_bins)
{

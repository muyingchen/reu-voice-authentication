...
/**********************************************************************/
void rank_int_arr(int *arr, int num, int *ptr_arr, float *rank_arr, int order)
{
    int i, j, tmp, count;
...
/*                   using this array to index arr, sorts the arr     */
/**********************************************************************/
void sort_float_arr(float *arr, int num, int *ptr_arr, int order)
{
    int i, j, dbg=0;
    float tmp;

    if (dbg) {
        printf("sort_float_array   %d elements\n",num);
        for (j=0;j<num;j++)
            printf("   %f\n",arr[j]);
    }
    /*  sort arr[ptr_arr[]] into ascending order */
...
/*                                                                    */
/**********************************************************************/
void rank_float_arr(float *arr, int num, int *ptr_arr, float *rank_arr, int order)
{
    int i, j, tmp, count;

...
extern void           fill_mark_struct(FILE *fp, WTOKE_STR1 *word_tokens, char *fname, boolean *end_of_file, int *perr);
...
extern void           get_next_mark_utt(FILE *fp, WTOKE_STR1 *word_tokens, char *fname, boolean *end_of_file, int *perr);

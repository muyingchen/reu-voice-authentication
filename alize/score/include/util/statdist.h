...
/* statdist.c */ void calc_mean_var_std_dev_Zstat PROTO((int *Z_list, int num_Z, float *mean, float *variance, float *std_dev, float *Z_stat)) ;
/* statdist.c */ void calc_mean_var_std_dev_Zstat_float PROTO((float *Z_list, int num_Z, float *mean, float *variance, float *std_dev, float *Z_stat)) ;
...
/* statdist.c */ int print_Z_analysis PROTO((float Z_stat)) ;
/* statdist.c */ int Z_pass PROTO((float Z_stat)) ;
/* statdist.c */ void calc_two_sample_z_test_float PROTO((float *l1, float *l2, int num_l1, int num_l2, float *Z)) ;

...
/* embedded in alphanumeric strings, like "m1".               */
       if (isdigit(*p))
         {switch (*p)
            {case '0': sp = strcat(sp," z '1 y r '0 ow");    break;
             case '1': sp = strcat(sp," w '1 ax n");         break;
             case '2': sp = strcat(sp," t '1 uw");           break;
             case '3': sp = strcat(sp," th r '1 iy");        break;
             case '4': sp = strcat(sp," f '1 ow r");         break;
             case '5': sp = strcat(sp," f '1 ay v");         break;
             case '6': sp = strcat(sp," s '1 ih k s");       break;
             case '7': sp = strcat(sp," s '1 eh v '0 ax n"); break;
             case '8': sp = strcat(sp," '1 ey t");           break;
             case '9': sp = strcat(sp," n '1 ay n");         break;
            }
          continue;
         }
/* separate letters */
       if (bound(*(p-1)) && bound(*(p+1)))
         {switch (*p)
            {case 'a': sp = strcat(sp," '1 ey");                     break;
             case 'b': sp = strcat(sp," b '1 iy");                   break;
             case 'c': sp = strcat(sp," s '1 iy");                   break;
             case 'd': sp = strcat(sp," d '1 iy");                   break;
             case 'e': sp = strcat(sp," '1 iy");                     break;
             case 'f': sp = strcat(sp," '1 eh f");                   break;
             case 'g': sp = strcat(sp," jh '1 iy");                  break;
             case 'h': sp = strcat(sp," '1 ey ch");                  break;
             case 'i': sp = strcat(sp," '1 ay");                     break;
             case 'j': sp = strcat(sp," jh '1 ey");                  break;
             case 'k': sp = strcat(sp," k '1 ey");                   break;
             case 'l': sp = strcat(sp," '1 eh l");                   break;
             case 'm': sp = strcat(sp," '1 eh m");                   break;
             case 'n': sp = strcat(sp," '1 eh n");                   break;
             case 'o': sp = strcat(sp," '1 ow");                     break;
             case 'p': sp = strcat(sp," p '1 iy");                   break;
             case 'q': sp = strcat(sp," k y '1 uw");                 break;
             case 'r': sp = strcat(sp," '1 aa r");                   break;
             case 's': sp = strcat(sp," '1 eh s");                   break;
             case 't': sp = strcat(sp," t '1 iy");                   break;
             case 'u': sp = strcat(sp," y '1 uw");                   break;
             case 'v': sp = strcat(sp," v '1 iy");                   break;
             case 'w': sp = strcat(sp," d '1 ax b '0 ax l y '2 uw"); break;
             case 'x': sp = strcat(sp," '1 eh k s");                 break;
             case 'y': sp = strcat(sp," w '1 ay");                   break;
             case 'z': sp = strcat(sp," z '1 iy");                   break;
            }
          continue;
	 }
/* geminate consonants */
